...
import {
  ...
  AlgGridAlgs,
  AlgGridItem
} from '../../components/styled/conferences';
import { Article } from '../../components/styled/article';
import { MainContainer } from '../../components/styled/container';
import F2lPattern from '../../components/conferences/f2l-pattern';
import Layout from '../../components/layout';
import OllPattern from '../../components/conferences/oll-pattern';
import PllPattern from '../../components/conferences/pll-pattern';
import cubingTabs from '../../data/conferences/conferences-tabs.yaml';
import intermediateCases from '../../data/conferences/intermediate-cases.yaml';
